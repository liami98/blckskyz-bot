...
bot.on("ready", async () => {
  ...
  bot.user.setActivity("Liam make me", {type: "WATCHING"})
});
...
if(cmd === `${prefix}kick`){
  ...
  if(!message.member.hasPermission("MANAGE_MESSAGES")) return message.channel.send("No can not use that command!");
